...
<Library LVVersion="24008000">
	...
	<Item Name="support" Type="Folder">
		<Item Name="Enqueue Message (Single).vi" Type="VI" URL="../../Keyence_VS150.lvlib_Message Queue/Enqueue Message (Single).vi"/>
		<Item Name="Enqueue Message (Array).vi" Type="VI" URL="../../DTU_EOL_RX_RY_V0.1.0.exe/Enqueue Message (Array).vi"/>
		<Item Name="All Message Queues.ctl" Type="VI" URL="../../Keyence_VS150.lvlib_Message Queue/All Message Queues.ctl"/>
	</Item>
	<Item Name="Create All Message Queues.vi" Type="VI" URL="../../Keyence_VS150.lvlib_Message Queue/Create All Message Queues.vi"/>
	<Item Name="Obtain Message Queue.vi" Type="VI" URL="../../Keyence_VS150.lvlib_Message Queue/Obtain Message Queue.vi"/>
</Library>
