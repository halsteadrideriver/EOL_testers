...
<Library LVVersion="24008000">
	...
	<Item Name="support" Type="Folder">
		<Item Name="Enqueue Message (Single).vi" Type="VI" URL="../../SSL_Certification.lvlib_Neoway Message Queue/Enqueue Message (Single).vi"/>
		<Item Name="All Message Queues.ctl" Type="VI" URL="../../SSL_Certification.lvlib_Neoway Message Queue/All Message Queues.ctl"/>
	</Item>
	<Item Name="Create All Message Queues.vi" Type="VI" URL="../../SSL_Certification.lvlib_Neoway Message Queue/Create All Message Queues.vi"/>
	<Item Name="Obtain Message Queue.vi" Type="VI" URL="../../SSL_Certification.lvlib_Neoway Message Queue/Obtain Message Queue.vi"/>
</Library>
